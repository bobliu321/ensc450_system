...
#  Created on Sat Apr 17 22:56:23 2021                
#                                                     
#######################################################
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -fplanOrigin center -site FreePDK45_38x28_10R_NP_162NW_34O -r 1 0.8 4 4 4 4
uiSetTool select
getIoFlowFlag
fit
set defOutLefVia 1
...
group_path -name in2reg_tmp.31751 -from {0xcd 0xd0} -to 0xd1 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.31751 -from {0xd4 0xd7} -to 0xd8 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.31751 -from 0xda -to 0xdb
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.31751 -from 0xde -to 0xdf
setPathGroupOptions reg2reg_tmp.31751 -effortLevel high
reset_path_group -name reg2out_tmp.31751
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.31751
set_global _is_ipo_interactive_path_groups 0
...
getPlaceMode -quiet -tdgpAdjustNetWeightBySlack
getPlaceMode -exp_slack_driven -quiet
reset_path_group -name reg2reg_tmp.31751
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.31751
set_global _is_ipo_interactive_path_groups 0
...
getPlaceMode -exp_slack_driven -quiet
checkPlace
saveNetlist results/verilog/aesbuffer.place.v
...
optDesign -preCTS
endECO
saveNetlist results/verilog/aesbuffer.postplaceopt.v
...
endECO
saveNetlist results/verilog/aesbuffer.postcts.v
...
globalDetailRoute
saveNetlist results/verilog/aesbuffer.route.v
...
defOut -placement -routing -floorplan results/aesbuffer.def
saveNetlist -phys -excludeLeafCell results/verilog/aesbuffer.phys.v
saveNetlist -excludeLeafCell results/verilog/aesbuffer.final.v
setExtractRCMode -engine postRoute
extractRC
rcOut -spef results/aesbuffer.spef
saveDesign DBS/aesbuffer.final.enc
...
loadWorkspace -name {Violation Browser + Physical}
saveDrc aesbuffer.viols.drc
violationBrowserReport -all -no_display_false -report aesbuffer.viols.rpt
streamOut aesbuffer -libName DesignLib -units 2000 -mode ALL
streamOut aesbuffer -libName DesignLib -units 2000 -mode ALL
saveDesign aesbuffer
